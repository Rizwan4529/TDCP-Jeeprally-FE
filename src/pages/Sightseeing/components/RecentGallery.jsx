            ...
            <div className="absolute top-0 left-0 z-0 pointer-events-none select-none">
                <div className="relative w-48 md:w-64 lg:w-80 h-48 md:h-64 lg:h-80">
                    <img
                        ...
                        alt=""
                        className="absolute top-[-4%] left-[-4%] w-[50%] h-auto opacity-90 rotate-[-10deg]"
                    />
                    <img
                        src={'/assets/images/flower2.png'}
                        alt=""
                        className="absolute top-[25%] left-[10%] w-[50%] h-auto opacity-70 rotate-[0deg]"
                    />
                    <img
                        src={'/assets/images/flower1.png'}
                        alt=""
                        className="absolute top-[30%] left-[20%] w-[50%] h-auto opacity-90 rotate-[60deg]"
                    />
                </div>
            </div>
